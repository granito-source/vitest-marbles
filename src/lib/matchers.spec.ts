...
describe('Matchers', () => {
    ...
    describe('#toBeObservable()', () => {
        ...
        it('matches actual errored out test observable with expected test observable', () => {
            expect(cold('--a-#', undefined, error))
                .toBeObservable(cold('--a-#', undefined, error));
            expect(cold('--a-#', undefined, error))
                .toBeObservable(hot('--a-#', undefined, error));
            expect(hot('--a-#', undefined, error))
                .toBeObservable(cold('--a-#', undefined, error));
            expect(hot('--a-#', undefined, error))
                .toBeObservable(hot('--a-#', undefined, error));
        });
